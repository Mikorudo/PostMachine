namespace WinPostMachine
{
    partial class CommandInputForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Size = new System.Drawing.Size(700, 314);
    ...
    " поста бла-бла-бла\n* 1...\n* 2...\n....\nВвод\n";
            ...
            this.загрузитьКомандыToolStripMenuItem.Size = new System.Drawing.Size(119, 20);
            this.загрузитьКомандыToolStripMenuItem.Text = "Открыть команды";
            this.загрузитьКомандыToolStripMenuItem.Click += new System.EventHandler(this.OpenCommandsFile);
            // 
            // сохранитьКомандуToolStripMenuItem
            // 
            this.сохранитьКомандуToolStripMenuItem.Name = "сохранитьКомандуToolStripMenuItem";
            this.сохранитьКомандуToolStripMenuItem.Size = new System.Drawing.Size(131, 20);
            this.сохранитьКомандуToolStripMenuItem.Text = "Сохранить команды";
            this.сохранитьКомандуToolStripMenuItem.Click += new System.EventHandler(this.SaveCommandsFile);
            // 
            // передатьНаМашинуToolStripMenuItem
            // 
            this.передатьНаМашинуToolStripMenuItem.Name = "передатьНаМашинуToolStripMenuItem";
            this.передатьНаМашинуToolStripMenuItem.Size = new System.Drawing.Size(135, 20);
            this.передатьНаМашинуToolStripMenuItem.Text = "Передать на машину";
            this.передатьНаМашинуToolStripMenuItem.Click += new System.EventHandler(this.SendCommands);
            // 
            // openFileDialog1
            // 
            ...
            // saveFileDialog1
            // 
            this.saveFileDialog1.Filter = "Тестовые файлы(*.txt) | *.txt";
            // 
            // CommandInputForm
            // 
